...
export function Hero() {
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 py-28 grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 items-center">
        {/* Left — Text */}
        <div>
          <motion.h1
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-text leading-tight"
          >
            Hey, I&apos;m Ali Hasan.
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-accent font-light italic mt-3"
          >
          ...
          <motion.div
            ...
            className="mt-8 space-y-4 text-[15px] text-text-muted leading-relaxed font-light"
          >
            <p>
              I&apos;m a Software Engineer focused on building mobile experiences that connect to real-world workflows.
              Currently at{" "}
              <a href="https://gomotive.com" target="_blank" rel="noopener noreferrer" className="font-medium text-text hover:text-accent transition-colors underline decoration-border hover:decoration-accent">
                Motive
              </a>
            ...
            <p>
              ...
              <a href="https://developer.amazon.com/apps-and-games/fire-tablets" target="_blank" rel="noopener noreferrer" className="font-medium text-text hover:text-accent transition-colors underline decoration-border hover:decoration-accent">
                Amazon
              </a>{" "}
            ...
            <p>
              ...
              <a href="https://www.linkedin.com/company/cginfinity/" target="_blank" rel="noopener noreferrer" className="font-medium text-text hover:text-accent transition-colors underline decoration-border hover:decoration-accent">
                CGInfinity
              </a>
          ...
          >
            <a href="https://github.com/Zyro9922" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 rounded-lg border border-border hover:border-accent/30 hover:text-accent transition-all text-sm text-text-muted">
        ...
        >
          <div className="w-[340px] h-[420px] rounded-2xl border border-border overflow-hidden shadow-sm">
            <Image
              src="/avatar.jpg"
              alt="Syed Ali Hasan"
              width={340}
